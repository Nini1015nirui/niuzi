...
data_root = '/mnt/d/Spatial-Mamba-main/dummy_ade20k_tiny'
...
train_cfg = dict(max_iters=1, type='IterBasedTrainLoop', val_interval=1)
...
tta_pipeline = [
    ...
    dict(
        transforms=[
            ...
            [
                dict(backend_args=None, type='LoadAnnotations'),
            ],
            [
                dict(type='PackSegInputs'),
            ],
...
work_dir = 'work_dirs/segmamba_tiny_test'
